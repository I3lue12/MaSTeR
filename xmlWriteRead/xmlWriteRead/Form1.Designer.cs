namespace xmlWriteRead
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(450, 75);
			...
			this.label1.Text = "Write To XML File";
			// 
			// label2
			// 
			...
			this.label2.Text = "Read To XML File";
			// 
			// button1
			// 
			...
			this.label6.Location = new System.Drawing.Point(371, 149);
